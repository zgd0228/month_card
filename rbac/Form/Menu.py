...
from rbac.Form.base import BootStrapModelForm
...
class PerModelForm(BootStrapModelForm):
...
class MultiAddPermissionForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['menus_id'].choices += Menu.objects.values_list('id', 'title')
